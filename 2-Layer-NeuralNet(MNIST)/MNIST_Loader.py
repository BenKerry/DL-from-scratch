...
def _init_MNIST():
    ...
    _log("<init_MNIST> Downloading MNIST Dataset...")
    ...
    _log("<init_MNIST> Loading Dataset...")
    ...
    _log("<init_MNIST> Dataset Loaded.")
    _log("<init_MNIST> Elapsed Time: {0}".format(time.time() - s))
